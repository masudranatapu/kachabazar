                           ...
                           <form action="{{ route('admin.size.store') }}" method="POST" >
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group row">
                                  <div class="col-xs-3">
                                    <label for="name">Size <i class="text-danger">*</i></label>
                                  </div>
                                  <div class="col-xs-9">
                                      <input type="text" required class="form-control" name="name" value=""  placeholder="Size">
                                  </div>
                              </div>
                        ...
                        <div class="card">
                            <div class="header">
                                <h2>
                                    ...
                                    <span class="badge bg-blue">{{ $size->count() }}</span>
                                </h2>
                            </div>
                            <div class="body">
                                            ...
                                            @foreach($size as $key=>$size)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        {{-- <button class="btn btn-danger waves-effect" type="button" onclick="deleteData({{ $size->id }})">
                                       ...
                                       <form action="{{ route('admin.size.update',$size->id) }}" method="POST"  >
                                        ...
                                        <div class="modal-body">
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-xs-9">
                                                  <input type="text" required class="form-control" name="name" value="{{$size->name}}"  placeholder="Size">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <div class="form-check">
                                                    <label class="radio-inline">
                                                    <input type="radio" name="status" value="Active" @if($size->status == "Active") checked @endif >Active</label>
                                                    <label class="radio-inline">
                                                    <input type="radio" name="status" @if($size->status == "Inactive") checked @endif value="Inactive"  >Inactive</label>
                                                </div>
                                            </div>
                                          </div>
